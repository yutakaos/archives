...
ggsave("figs/Fig_5b.png", plot=gp_1, width=4, height=6)
ggsave("figs/Fig_5c.png", plot=gp_2, width=4, height=6)
...
ggsave("figs/Fig_5d.png", plot=gp_3, width=3, height=4)
...
gp_4 <- ggplot(df, aes(x=date, y=asv, color=plot)) +
    geom_line() + facet_wrap(~ taxa, nrow=2) +
    labs(x="Date (month)", y="Standardized DNA copy") + 
    theme_bw() + theme(legend.position="none")
ggsave("figs/Fig_5a.png", plot=gp_4, width=11, height=4)
